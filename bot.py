...
async def text_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if step == "fake_q4":
        ...
        await update.message.reply_text(
            ...
            "Press 'Still Here' within 10 seconds so I know you're safe.\n"
            "If you stop responding I will alert your emergency contacts.\n\n"
            "Type 'Iam Safe' to stop fake texting."
        )
...
async def fake_chat_loop(context, user_id):
    ...
    while True:
        ...
        keyboard = InlineKeyboardMarkup([
            [InlineKeyboardButton("Still Here", callback_data="fake_ok")]
        ])
        ...
        if not context.user_data.get("ok_pressed"):
            ...
            for c in contacts:
                await context.bot.send_message(
                    c,
                    f"⚠️ @{context.bot_data.get('username','user')} stopped responding during fake texting."
                )
            ...
            if context.user_data["missed"] >= 5:
                ...
                for c in contacts:
                    await context.bot.send_message(
                        c,
                        f"Collected fake texting details:\n\n{clues}"
                    )
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "fake_ok":
        ...
        await query.edit_message_text("That is great to hear. Let me know once you're safe.")
        return
